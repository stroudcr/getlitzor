...
const WebsiteDesignPage: FC = () => {
  ...
  const faqs: FAQProps[] = [
    ...
    },
    {
      ...
      answer: "Yes! We build sites with user-friendly content management systems that let you easily update text, images, and pages without any coding knowledge. We also provide training and documentation so you feel confident making changes on your own."
    }
  ];
